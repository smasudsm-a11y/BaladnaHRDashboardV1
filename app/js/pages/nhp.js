import { sortGrades, sortedUnique, withEmployeeFields, fmtInt, fmtPct, legalEntityAllowed } from "../data.js";
import { kpiCard, chartCard, barChart, doughnutChart, legalEntityFilter } from "../charts.js";
...
export function render({ db, contentEl, filtersEl }) {
  ...
  function draw() {
    contentEl.innerHTML = "";
    const rows = enriched.filter((t) => t.trainingCategory === "New Hire Program" && legalEntityAllowed(db, t.legalEntity));

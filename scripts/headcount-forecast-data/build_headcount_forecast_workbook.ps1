# CSV -> Database/18_Headcount_Forecast.xlsx (sheet "Headcount Forecast
# Data"). Reuses build_ctc_workbook.ps1's Write-SheetFromRows helper
# verbatim, including its two documented gotchas (see CLAUDE.md's CTC
# Report gotcha):
...
#     Excel auto-converts "2026-09-01" to a date serial, and SheetJS's
...
$outPath = "$repoRoot\Database\18_Headcount_Forecast.xlsx"

$forecast = Import-Csv "$dir\headcount_forecast.csv"
...
$ws1.Name = "Headcount Forecast Data"
Write-SheetFromRows $ws1 @("Period", "Division", "Forecast Headcount", "Lower Bound", "Upper Bound") $forecast @("Period", "Division", "ForecastHeadcount", "LowerBound", "UpperBound") @(0)

# Only 1 sheet is needed here — drop any extra blank default sheets
# Workbooks.Add() may have created.
